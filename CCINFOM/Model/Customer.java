...
public class Customer {
    ...
    public static boolean signUp(String firstName, String lastName, String phone, String email, String dob) {
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bankdb", "java", "password")) {
            ...
            // Insert new customer
            String insertQuery = "INSERT INTO customer (customer_first_name, customer_last_name, phone_number, email_address, birth_date) VALUES (?, ?, ?, ?, ?)";
